...
const updateParkiran = async (event) => {
    ...
    const targetURL = 'https://asia-southeast2-pakarbi.cloudfunctions.net/updatedataparkiran'
...
const apiUrl = 'https://asia-southeast2-pakarbi.cloudfunctions.net/getonedataparkiran';
